...
public class TutorialHighlighter : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Remet la couleur normale au d�marrage
    ...
    void Update()
    {
        if (isActive)
        {
            ...
            // Debug moins r�p�titif : afficher une fois par seconde max
    ...
    public void ActivateHighlight()
    {
        ...
        Debug.Log($"ActivateHighlight appel� sur {gameObject.name}");
    }
    ...
    public void DeactivateHighlight()
    {
        ...
        Debug.Log($"DeactivateHighlight appel� sur {gameObject.name}");
    }
}